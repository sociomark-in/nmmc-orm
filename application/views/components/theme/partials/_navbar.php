		...
		<ul class="navbar-nav">
			...
			<!-- <li class="nav-item dropdown">
				...
				<div class="dropdown-menu" aria-labelledby="languageDropdown">
					<a href="<?= base_url("") ?>" class="dropdown-item py-2"><i class="flag-icon flag-icon-us" title="us" id="us"></i> <span class="ms-1"> English </span></a>
					<a href="<?= base_url("") ?>" class="dropdown-item py-2"><i class="flag-icon flag-icon-fr" title="fr" id="fr"></i> <span class="ms-1"> French </span></a>
					<a href="<?= base_url("") ?>" class="dropdown-item py-2"><i class="flag-icon flag-icon-de" title="de" id="de"></i> <span class="ms-1"> German </span></a>
			...
			<li class="nav-item dropdown">
				...
				<div class="dropdown-menu p-0" aria-labelledby="appsDropdown">
					<div class="px-3 py-2 d-flex align-items-center justify-content-between border-bottom">
						...
						<a href="<?= base_url("") ?>" class="text-muted">Edit</a>
					</div>
					<div class="row g-0 p-1">
						<div class="col-3 text-center">
							<a href="<?= base_url("") ?>pages/apps/chat.html" class="dropdown-item d-flex flex-column align-items-center justify-content-center wd-70 ht-70"><i data-feather="message-square" class="icon-lg mb-1"></i>
			...
			<li class="nav-item dropdown">
				...
				<div class="dropdown-menu p-0" aria-labelledby="messageDropdown">
					<div class="px-3 py-2 d-flex align-items-center justify-content-between border-bottom">
						<p>9 New Messages</p>
						<a href="<?= base_url("") ?>" class="text-muted">Clear all</a>
					</div>
					<div class="p-1">
			...
			<li class="nav-item dropdown">
				<a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					<img class="wd-30 ht-30 rounded-circle" src="https://ui-avatars.com/api/?name=<?= $session['appuser']['username'] ?>" alt="Profile">
				</a>
				<div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
					<div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
						<div class="mb-3">
							<img class="wd-80 ht-80 rounded-circle" src="https://ui-avatars.com/api/?name=<?= $session['appuser']['username'] ?>" alt="Profile">
						</div>
						<div class="text-center">
							<p class="tx-16 fw-bolder"><?= ucfirst($session['appuser']['role']['name']) ?></p>
							<p class="tx-12 text-muted"><?= $session['appuser']['username'] ?></p>
						</div>
					</div>
					<ul class="list-unstyled p-1">
						...
						<li class="dropdown-item py-2">
							<a href="<?= base_url("login") ?>" class="text-body ms-0">
